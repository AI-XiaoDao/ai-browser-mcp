...
> **Windows local browser automation MCP server** — 268 tools for Cursor, Claude Desktop, Cline, or any MCP client.  
...
|---------|----------|------|
| [AI-Browser-MCP-x64-v2.8.0.zip](https://github.com/AI-XiaoDao/ai-browser-mcp/releases/download/v2.8.0/AI-Browser-MCP-x64-v2.8.0.zip) | Windows 64-bit | ~160 MB |
| [AI-Browser-MCP-win32-v2.8.0.zip](https://github.com/AI-XiaoDao/ai-browser-mcp/releases/download/v2.8.0/AI-Browser-MCP-win32-v2.8.0.zip) | Windows 32-bit | ~140 MB |

All **268 tools** included (screenshot, CDP, debugger, fingerprint, network hook, workflows). **MIT** open source.
