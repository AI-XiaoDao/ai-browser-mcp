...
> **Windows local browser automation MCP server** — 217 tools for Cursor, Claude Desktop, Cline, or any MCP client.  
> Repository: https://github.com/AI-XiaoDao/ai-browser-mcp

## What is this?

**AI Browser MCP Server** (AI浏览器 MCP) exposes a real **FBrowser CEF** browser on Windows via the **Model Context Protocol (MCP)**. Instead of writing **Playwright** or **Puppeteer** scripts, your AI agent calls **217 ready-made `browser_*` tools** over HTTP, WebSocket, or stdio.
...
|---------|----------|------|
| [AI-Browser-MCP-x64-v2.6.0.zip](https://github.com/AI-XiaoDao/ai-browser-mcp/releases/download/v2.6.0/AI-Browser-MCP-x64-v2.6.0.zip) | Windows 64-bit | ~157 MB |
| [AI-Browser-MCP-win32-v2.6.0.zip](https://github.com/AI-XiaoDao/ai-browser-mcp/releases/download/v2.6.0/AI-Browser-MCP-win32-v2.6.0.zip) | Windows 32-bit | ~136 MB |

All **217 tools** included (screenshot, CDP, debugger, fingerprint, network hook, workflows). **MIT** open source.
...
| AI | Agent writes code each time | **217 MCP tools** pre-built |
...
| 217 tool reference | [AI浏览器MCP.md](../skills/AI浏览器MCP.md) |
