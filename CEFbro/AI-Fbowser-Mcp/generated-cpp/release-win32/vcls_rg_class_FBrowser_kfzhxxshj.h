...
public:
    ...
    virtual void rg_KaiFaZheXiaoXi_VIP_ShouDaoShiJian (rg_FBrowser_LiuLanQi::rg_class_FBrowser_LiuLanQi& rg_LiuLanQi164, CVolString& rg_FangFaMing13, INT rg_CanShuZhiZhen1, INT rg_CanShuDaXiao1);
