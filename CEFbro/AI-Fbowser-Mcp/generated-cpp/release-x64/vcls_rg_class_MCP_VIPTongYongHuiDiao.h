...
public:
    virtual void rg_ShuJuHuiDiao (rg_FBrowser_LiuLanQi::rg_class_FBrowser_LiuLanQi& rg_LiuLanQi53, INT rg_BiaoShiID1, BOOL rg_ChengGong2, INT64 rg_ShuJuZhiZhen1, INT rg_ShuJuDaXiao1);
