...
BOOL rg_ChuangKouChengXuLei::rg_XiaoXiGuoLu (INT64 rg_ChuangKouGouBing3, INT rg_XiaoXiZhi, INT64 rg_XiaoXiCanShu, INT64 rg_XiaoXiCanShu1, INT64 rg_XiaoXiDeZhi)
{
    return (TRUE);
}
...
BOOL rg_DongTaiKuChengXuLei::rg_RuKouTongZhi (INT64 rg_MoKuaiGouBing, INT rg_DiaoYongYuanYin, INT64 rg_BaoLiuZhiZhen)
{
    return (TRUE);
}
