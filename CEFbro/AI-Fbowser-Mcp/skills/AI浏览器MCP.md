---
name: AI浏览器MCP
description: AI浏览器 MCP 服务工具参考 - 255个浏览器自动化工具 (v3.0.0: AI交互6工具/browser_reverse_*套件/断点注册表/事件时间线/HAR导出/retry)
version: 3.0.0
