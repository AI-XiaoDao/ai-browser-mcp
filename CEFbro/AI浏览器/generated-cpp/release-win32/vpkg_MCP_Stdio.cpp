...
CVolString CALLBACK rg_MCPStdioQiao::rg_DouQuYiHang (INT rg_XianChengGouBing)
{
    ...
    for (;;) {
        if (rg_StdioYingTuiChu) return CVolString();
...
INT rg_class_MCP_StdioFuWuXianCheng::rg_HuanCunXianChengLei_XianChengYunHang (rg_volcano_base::rg_HuanCunXianChengLei& rg_LaiYuanDuiXiang12, INT rg_BiaoJiZhi12, INT rg_XianChengGouBing2, INT rg_YongHuCanShu, INT rg_TuiChuShiJian)
{
