...
public:
    ...
    static CVolString CALLBACK rg_ZhiHangGongZuoLiuChanBu (CVolString& rg_MingLingID31, rg_HuoShanShiChuang_JSONZhiChi::rg_YYJSONZhiDouDuiXiangLei& rg_BuZhou, INT rg_BuSuoYin1, CVolString& rg_QuanJuonError, rg_volcano_base::rg_WenBenShuZuLei& rg_BuZhouJieGuoJSONLieBiao1);
    static BOOL CALLBACK rg_BuZhouShuZuMoXiao (rg_HuoShanShiChuang_JSONZhiChi::rg_YYJSONZhiDouShuZuLei& rg_BuZhouShuZu1);
    ...
    static CVolString CALLBACK rg_ChuLi_GongZuoLiuYunHang (CVolString& rg_MingLingID32, rg_HuoShanShiChuang_JSONZhiChi::rg_YYJSONZhiDouDuiXiangLei& rg_CanShuJSON23);
