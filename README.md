...
1. **下载** [x64](https://github.com/AI-XiaoDao/ai-browser-mcp/releases/download/v2.6.0/AI-Browser-MCP-x64-v2.6.0.zip)（~157MB）或 [win32](https://github.com/AI-XiaoDao/ai-browser-mcp/releases/download/v2.6.0/AI-Browser-MCP-win32-v2.6.0.zip)（~136MB）→ 解压 → 双击 **`AI浏览器.exe`**
...
| 完整安装包 x64 | [GitHub Releases](https://github.com/AI-XiaoDao/ai-browser-mcp/releases) | `AI-Browser-MCP-x64-v2.6.0.zip`：**217 工具全开放**，exe + CEF + 文档/脚本 |
...
| 生成 C++ 源码 | [`generated-cpp/`](CEFbro/AI浏览器/generated-cpp/) | `release-x64/`、`release-win32/` 火山翻译对照（亦见 Release cpp zip） |
...
维护者发版：详见 [`generated-cpp/README.md`](CEFbro/AI浏览器/generated-cpp/README.md) · [`CONTRIBUTING.md`](CONTRIBUTING.md)。
