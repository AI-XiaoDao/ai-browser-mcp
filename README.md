...
打开目标网站（如 https://example.com），找出 POST 请求里疑似加密的字段并说明依据。
...
| AI 集成 | Agent 现写代码，易出错 | **255 个预封装 MCP 工具**，Agent 直接调用 |
...
| 分派层 | `src/MCP_Server_Core/Form/VIP/System/Workflow/Reverse.wsv` | 255 工具实现 |
...
│   ├── docs/             # 客户手册、配置说明、快速上手
│   ├── skills/           # Agent 技能书 + 255 工具参考 + 火山模块 API 摘要
│   ├── workflows/        # 工作流 JSON
│   ├── mcp_bridge.js     # Cursor stdio 桥接
│   ├── full_test.js / regression_sync_wait.js  # 冒烟回归脚本
│   └── test_fixtures/    # 测试夹具
├── release/              # 发行辅助脚本
...
| 文档 | 读者 |
|------|------|
| [255 工具完整参考](CEFbro/AI-Fbowser-Mcp/skills/AI浏览器MCP.md) | 开发者 / Agent |
