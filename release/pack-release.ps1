...
foreach ($plat in $platforms) {
    $linker = Get-ChildItem -Path $aiDir.FullName -Recurse -Directory -ErrorAction SilentlyContinue |
    ...
    $project = Get-ChildItem -Path $aiDir.FullName -Recurse -Directory -ErrorAction SilentlyContinue |
